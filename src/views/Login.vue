      ...
      <div class="hero-section">
        <div class="hero-overlay">
          ...
          <div class="hero-content">
            ...
            <div>
              <h2 class="hero-title">
                Encontre respostas instantâneas em seus documentos
              </h2>
              <p class="hero-description">
                Transforme a maneira como sua equipe acessa informações.
                Consulte milhares de documentos em segundos e mantenha todos
                atualizados com o conteúdo mais recente.
              </p>
            </div>
